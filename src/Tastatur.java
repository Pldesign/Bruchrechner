...
public class Tastatur extends JPanel implements ActionListener {
	...
	public Tastatur(Termrechner rech) {
		...
		setLayout(new GridLayout(0, 1, 0, 0));
				...
				STO.setToolTipText("Variable wird auf den Inhalt der Rechnung gesetzt! \r\nBei Auswahl von STO werden alle Variablen zur\u00FCckgesetzt.");
				STO.setFont(UIManager.getFont("Button.font"));
				STO.setModel(new DefaultComboBoxModel<String>(new String[] {"STO", ">a", ">b", ">c", ">d", ">f", ">g", ">h", ">u", ">v", ">w", ">x", ">y", ">z"}));
				...
				var.setModel(new DefaultComboBoxModel<String>(new String[] {"VAR", "a", "b", "c", "d", "f", "g", "h", "u", "v", "w", "x", "y","z"}));
